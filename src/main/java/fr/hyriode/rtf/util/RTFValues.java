...
public class RTFValues {
    ...
    public static final ValueProvider<Boolean> REMOVE_BLOCKS = new ValueProvider<>(true).addModifiers(new HostValueModifier<>(1, Boolean.class, "remove-blocks"), new ValueModifier<>(2, () -> HyriRTF.get().getGame().getType().equals(RTFGameType.SOLO), () -> true));
